...
st.markdown("""
    ...
    .stButton>button {
        ...
        border: 1px solid #D4AF37 !important; border-radius: 10px !important; font-size: 20px !important;
    }
    .card {
    ...
    .spec-card {
        ...
        padding: 20px; border-radius: 12px; border-left: 6px solid #D4AF37; line-height: 1.6;
    }
...
# Daten laden
df_tanken = load_gsheet_data("tanken")
df_service = load_gsheet_data("service")
...
if menu == "⛽ Tanken":
    ...
    if st.button("Speichern ✅"):
        ...
        save_gsheet_data(df_tanken, "tanken")
        st.rerun()
    ...
    st.markdown("<div class='spec-card'><b>Modell:</b> Mercruiser 496 MAG HO<br><b>Hubraum:</b> 8.1 Liter V8</div>", unsafe_allow_html=True)
    ...
    if st.button("Eintrag speichern"):
        ...
        save_gsheet_data(df_service, "service")
        st.rerun()
    ...
    st.metric("TOTAL KOSTEN", f"CHF {(f_winter + f_platz + sprit_sum + serv_sum):,.2f}")
    st.markdown("</div>", unsafe_allow_html=True)
